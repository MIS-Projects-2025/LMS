...
3. Fill in the fields:
   - **Locker No** *(required)* — unique identifier for the locker (e.g., "L-001", "A-042")
   - **Employee** *(optional)* — type 3+ characters to search; select from dropdown
     - If left blank → locker status will be **Vacant**
   - **Passcode** *(optional)* — the locker's combination or code
   - **Notes** *(optional)* — any additional information (max 255 characters)
4. Click **Save**
